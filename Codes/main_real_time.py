...
#	global streetList
	...
	if(frame_count == 1):
		Camera_matrix, focal_length = helpers.exist(Camera_name, img)
...
#			print("Vel= ", vel)
			...
			img= helpers.draw_box_label(img, x_cv2, trk.box_color, trk.id, trk.colorProb, distance, angle, vel, img.shape[1], img.shape[0], warning) # Draw the bounding boxes on the
...
if __name__ == "__main__":
	...
	cap = cv2.VideoCapture('http://192.168.1.51:8080/video')
	#cap = cv2.VideoCapture(0)
	#filename = '/home/camilo685/Desktop/Tesis/Code/salida_test.avi'
	filename = '/home/camilo685/Desktop/15_600_480.mp4'
	#codec = cv2.VideoWriter_fourcc('X', 'V', 'I', 'D')
	codec = cv2.VideoWriter_fourcc(*"mp4v") 
	frame_width = int(cap.get(3))
	frame_height = int(cap.get(4))
	
	#print("fw = ", frame_width,"fh = ", frame_height)
	...
	Output = cv2.VideoWriter(filename, codec, fps, (frame_width,frame_height))
